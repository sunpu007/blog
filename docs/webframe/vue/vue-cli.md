...
**命令行界面**（英语：**command-line interface**，[缩写](https://baike.baidu.com/item/缩写/1948062)：**CLI**）是在图形用户界面得到普及之前使用最为广泛的[用户界面](https://baike.baidu.com/item/用户界面/6582461)，它通常不支持[鼠标](https://baike.baidu.com/item/鼠标/122323)，用户通过键盘输入指令，计算机接收到指令后，予以执行。
